...
Methodology
Load Dataset – used Scikit-learn's built-in Iris dataset (no manual download needed)
Exploratory Data Analysis – visualized sepal and petal measurements across species
Train/Test Split – held out 20% of data for unbiased evaluation
Model Training – compared Decision Tree, Random Forest, and SVM classifiers
Model Evaluation – accuracy, precision, recall, F1-score, and confusion matrix
Feature Importance – identified which measurements matter most for classification
Key Findings
